                    ...
                    <div className="items-center lg:flex">
                        <div className="w-full lg:w-1/2">
                            <div className="lg:max-w-lg">
                                ...
                                <Link href={"/quiz"}>
                                    <button className="w-full px-5 py-2 mt-6 text-sm tracking-wider text-white uppercase transition-colors duration-300 transform bg-secondary rounded-lg lg:w-auto hover:bg-orange-600 focus:outline-none focus:bg-blue-500">Start a Quiz</button>
                                </Link>
                            </div>
                        </div>
