    ...
    return (
        <div className='max-w-7xl mx-auto my-10'>
            <div className='flex flex-col gap-6'>
                ...
                <Link className='bg-secondary text-center p-4 font-bold text-2xl hover:bg-primary hover:text-white' href={"/"}>Chapter 3</Link>
